<?php
/**
 * Phobos functions and definitions.
 *
...
if ( ! function_exists( 'phobos_setup' ) ) :
/**
...
function phobos_setup() {
	 ...
	 * If you're building a theme based on Phobos, use a find and replace
	 * to change 'phobos' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'phobos', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'phobos' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'phobos_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif;
add_action( 'after_setup_theme', 'phobos_setup' );
 ...
 */
function phobos_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'phobos_content_width', 640 );
}
add_action( 'after_setup_theme', 'phobos_content_width', 0 );
 ...
 */
function phobos_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'phobos' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'phobos' ),
...
add_action( 'widgets_init', 'phobos_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'phobos_scripts' );
